...
# assuming that the inout dataset has the following directory name "dataset_name/{class_name}/example.jpg"
...
# for the changes to the model to tale affect we need to recompile
