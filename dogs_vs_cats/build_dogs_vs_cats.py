...
# files
datasets = [
    ("train", trainPaths, trainLabels, config.TRAIN_H5),
    ("val", valPaths, valLabels, config.VAL_H5),
    ("test", testPaths, testLabels, config.TEST_H5)]
...
for (dType, paths, labels, outputPath) in datasets:
    ...
    for (i, (path, label)) in enumerate(zip(paths, labels)):
        ...
        # add the image and label # to the H5 dataset
